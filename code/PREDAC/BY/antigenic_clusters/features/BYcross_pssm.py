# -*- coding: utf-8 -*-
# @Time    : 2023/12/25 下午9:07
# @Author  : Hanwenjie
# @project : code
# @File    : BYcross_pssm.py
# @IDE     : PyCharm
# @REMARKS : 说明文字
...
df = pd.read_csv('../../../../data/sequence/features_related/BY_ALL_SCAN.csv')
...
with open(r'../../../../data/sequence/features_related/BY_RSA_freesasa.txt') as f:
    lines = f.readlines()
...
# print(list_E)
# print(epiE_index)
# epi_A.to_csv(r'/home/hanwenjie/Project/PAV-Bsubtype/data/original_data/BY_gasaid/BY_region_seq/data_process/unfill/epitope/epi_A.csv')
...
# print(df_BY)
# df_BY.to_csv(r'/home/hanwenjie/Project/PAV-Bsubtype/data/original_data/BY_gasaid/BYseq_final/BYpre_epitope/ScanNet/BY_ALL_SCAN/BYPDB.csv')

estimator = KMeans(n_clusters=5,random_state=2022)   #构造聚类器
estimator.fit(df_BY.loc[list_index,['x_coord','y_coord','z_coord']])      #聚类
label_pred = estimator.labels_     #获取聚类标签
df_BY.loc[list_index,'label'] = label_pred
# df_BY.to_csv(r'/home/hanwenjie/Project/PAV-Bsubtype/data/original_data/BY_gasaid/BYseq_final/BYpre_epitope/test.csv')
...
path = '../../../../data/sequence/features_related/BY.pssm'
...
data = pd.read_csv(r'../../../../data/result/BYHA1_predictdata.csv',index_col=0)
...
data.to_csv(r'../../../../data/result/BYHA1_predictdata.csv')
