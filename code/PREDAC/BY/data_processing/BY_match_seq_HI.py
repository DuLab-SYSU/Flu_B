# -*- coding: utf-8 -*-
# @Time    : 2023/12/24 上午11:29
# @Author  : Hanwenjie
# @project : code
# @File    : BY_match_seq_HI.py
# @IDE     : PyCharm
# @REMARKS : 说明文字
import pandas as pd


seq = pd.read_csv(r"../../../../sequence/BYHA1_after_fillandrename.csv",index_col=0)
seq.rename(columns={'virus':'virus_1'},inplace=True)
HI = pd.read_csv(r'/home/hanwenjie/Project/PAV-Bsubtype/data/original_data/BY_gasaid/BY_region_seq/data_process/unfill/'
                 r'HI/BYHI.csv',index_col=0)
...
df_final.to_csv(r'../../../../data/result/BY_model.csv')
