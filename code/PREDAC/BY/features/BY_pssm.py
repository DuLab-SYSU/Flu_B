...
#extract top 150 antigenic probability and exposed sites
...
#head domain region of HA segment
...
#convert site numbers to actual positions
...
# column indices for locating PSSM matrix
...
def pssm_diff(list_index, seq1, seq2):
    '''calculate the summed PSSM score difference for each epitope'''
...
#calculate epitope-PSSM features
...
data.to_csv(r'./result/BY_model.csv')
