...
def process_extinction_time(args):
    cv, cy = args
    df = pd.read_csv(f"./result/simmulation/data_w/data_simmulation_orign_cv{cv:.2f}_cy{cy:.2f}.csv", index_col='time_plot')
...
df_by_time.to_csv(r"./result/simmulation/by_extinction_time_changeW.csv")
...
df_by_size.to_csv(r"./result/simmulation/by_extinction_size_changeW.csv")
