...
def dz_dt(z, t, tv_c, ty_c, w_v, w_y, R0_v, R0_y, D, ksi, Lv, Ly, omega, cv_old, cv_new, cy_old, cy_new, immue_esp_pct_v1, immue_esp_pct_v2, immue_esp_pct_v3, immue_esp_pct_y1, immue_esp_pct_y2, npi_intensity, npi_start, npi_end, tv_0, ty_0, T, immue_esp_vt1, immue_esp_vt2, immue_esp_vt3, immue_esp_yt1, immue_esp_yt2, Pv, Py):
    ...
    # cross protection
    cv = jnp.where((t >= tv_c), cv_new, cv_old)
    cy = jnp.where((t >= ty_c), cy_new, cy_old)
...
def generate_data(S_rate_ini, Iv_rate_ini, Iy_rate_ini, Rcv_rate_ini, Rcy_rate_ini,
                  ...
                  R0_v, R0_y, w_v, w_y, cv_old, cv_new, cy_old, cy_new, tv_0, ty_0, tv_c, ty_c, immue_esp_pct_v1, immue_esp_pct_v2, immue_esp_pct_v3, 
...
for cv_value in tqdm(np.arange(0.0, 1.01, 0.01)):
    for cy_value in np.arange(0.0, 1.01, 0.01):
        ...
        df_result.to_csv(f"./result/simmulation/data_c/data_simmulation_orign_cv{cv_value:.2f}_cy{cy_value:.2f}.csv") 
